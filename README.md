...
I'm an experienced software engineer with a demonstrated history of working in the gaming, fashion, and healthcare industries. Skilled in Programming, Analytics, Operations and People Management, and Entrepreneurship. Programming has always been a hobby of mine, so I decided to double-down on making this my career instead. I'm extremely proud of my accomplishments so far, and am motivated to keep the momentum going by learning from and helping like-minded individuals. My current tech stack includes, but is not limited to:
